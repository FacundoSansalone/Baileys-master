...
// import { WAMHandler } from './wam' // Comentado temporalmente
...
const startSock = async() => {
	...
	// const wam = new WAMHandler(sock, state) // Comentado temporalmente
		...
		async(events) => {
			...
			if(events['connection.update']) {
				...
				if(qr) {
					...
					console.log('\n⏱️  El código expira en 30 segundos. Se generará uno nuevo automáticamente.\n')
				}
				...
				if(connection === 'open') {
					console.log('✅ CONEXIÓN EXITOSA! Ya estás conectado a WhatsApp')
				}
